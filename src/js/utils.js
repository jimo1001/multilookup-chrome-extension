...
(function () {
  ...
  root.getURLtoHost = getURLtoHost;
  ...
  root.getURLtoDirPath = getURLtoDirPath;
  ...
  root.removeXSSRisk = removeXSSRisk;
  ...
  root.createHTMLDocumentByString = createHTMLDocumentByString;
  ...
  root.isInstanceof = isInstanceof;
  ...
  root.jsonFormatter = jsonFormatter;
